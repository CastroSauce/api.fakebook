...
namespace api.fakebook.Migrations
{
    ...
    [Migration("20211201231429_added mentions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.fakebook.Models.Authentication.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("api.fakebook.Models.PostModels.Mention", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("api.fakebook.Models.Authentication.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("api.fakebook.Models.PostModels.Mention", b =>
                {
                    b.HasOne("api.fakebook.Models.Post", "mentionPost")
                        .WithMany()
                        .HasForeignKey("mentionPostId");

                    b.HasOne("api.fakebook.Models.Authentication.ApplicationUser", "mentionedUser")
                        .WithMany()
                        .HasForeignKey("mentionedUserId");

                    b.Navigation("mentionedUser");

                    b.Navigation("mentionPost");
                });
            ...
            modelBuilder.Entity("api.fakebook.Models.UserModels.Follow", b =>
                {
                    b.HasOne("api.fakebook.Models.Authentication.ApplicationUser", "followTarget")
                        .WithMany()
                        .HasForeignKey("followTargetId");

                    b.HasOne("api.fakebook.Models.Authentication.ApplicationUser", "follower")
                        .WithMany()
